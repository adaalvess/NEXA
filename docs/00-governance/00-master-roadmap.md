...
| 7 | Desenvolvimento da Plataforma (código) | 🔄 Em curso — M1 (Fundação), M2 (Módulos Core), M3 (Assistente de IA) e M4 (Comercial e Pagamentos) formalmente concluídos (Passos 0-23); NFR-17 coberto na íntegra; Risco R3 resolvido, RN-11 aplicada de forma uniforme, ciclo completo de UC-07/UC-08 fechado de ponta a ponta (Checkout + Webhooks + Ecrã de Subscrição); M5 (Camada Comercial e Produto) aprovado e em curso — Bloco A (EP-07) formalmente concluído (Passos 24-26); Bloco B em curso, Passo 27 (`PATCH /utilizadores/me`) concluído |
...
| **M8** | Início do desenvolvimento (Fase 7, Claude Code) | 🔄 Em curso — Blueprint M1 (Fundação), M2 (Módulos Core), M3 (Assistente de IA) e M4 (Comercial e Pagamentos) formalmente concluídos (Passos 0-23); NFR-17 coberto na íntegra; Risco R3 resolvido, RN-11 aplicada de forma uniforme, ciclo completo de UC-07/UC-08 fechado de ponta a ponta; M5 (Camada Comercial e Produto) aprovado e em curso — Bloco A (EP-07) formalmente concluído (Passos 24-26); Bloco B em curso, Passo 27 (`PATCH /utilizadores/me`) concluído |
