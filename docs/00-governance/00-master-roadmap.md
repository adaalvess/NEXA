...
| 7 | Desenvolvimento da Plataforma (código) | 🔄 Em curso — M1 (Fundação) e M2 (Módulos Core) formalmente concluídos (Passos 0-14); M3 (Assistente de IA) em curso — Passo 15 (AI Gateway) e Passo 16 (`POST /ia/perguntar`) concluídos |
...
| **M8** | Início do desenvolvimento (Fase 7, Claude Code) | 🔄 Em curso — Blueprint M1 (Fundação) e M2 (Módulos Core) formalmente concluídos (Passos 0-14); M3 (Assistente de IA) em curso — Passo 15 (AI Gateway) e Passo 16 (`POST /ia/perguntar`) concluídos |
